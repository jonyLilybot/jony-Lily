...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "আহ গো সোনা আমার তোমার অলিতে গলিতে উম্মাহ😇😘",
          "কি গো সোনা আমাকে ডাকছো কেনো😗",
          "বার বার আমাকে ডাকস কেন😡😤দেখোস না আমি জনি বস ও লিলি ম্যামের সাথে সাথে বিজি আছি🤭😍🥱",
          "আহ শোনা আমার আমাকে এতো ডাক্তাছো কেনো আসো বুকে আশো🥱",
          "হুম জান তোমার চিপায় চাপায় অলিতে গলিতে অইখানে উম্মমাহ😷😘",
          "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি🥱",
          "আমাকে এতো না ডেকে বস জনি কে একটা জিএফ দে 🙄",
          "বার বার না ডেকে একেবারে বলে দাও ভালোবাসি 😍🥱",
          "jang bal falaba🙂"
        ];
